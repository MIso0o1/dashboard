    ...
    <>
      <Sidebar className="border-r border-slate-200/50 glass-effect">
        ...
        <SidebarContent className="custom-scrollbar">
          <SidebarGroup>
            <SidebarGroupLabel className="text-slate-700 font-semibold">Navigation</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
          ...
          <SidebarGroup>
            <SidebarGroupLabel className="text-slate-700 font-semibold">Add Widgets</SidebarGroupLabel>
            <SidebarGroupContent>
          ...
          <SidebarGroup>
            <SidebarGroupLabel className="text-slate-700 font-semibold">Dashboard Stats</SidebarGroupLabel>
            <SidebarGroupContent>
